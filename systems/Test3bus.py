...
class test3bus(Network):
    ...
    def _create_loads(self):
        ...
        self.loads = [
            ...
            Load(id=2, bus=self.buses[2], p_input=0.25, q_input=0),  # Bus 3
        ]
    ...
    def _create_lines(self):
        ...
        self.lines = [
            ...
            Line(id=2, from_bus=self.buses[0], to_bus=self.buses[2], r=0.0, x=0.1),
            Line(id=3, from_bus=self.buses[1], to_bus=self.buses[2], r=0.0, x=0.1),
        ]
